...
### YZ Modified
To run fine-tuning code:
- Modify the yaml file in the following path if necessary:
```
/LLaMA-Factory/examples/train_qlora/llama_primus_lora_sft_otfq.yaml
```
- Run bash/PBS job script to fine-tune:
```
...
```
/LLaMA-Factory/data/primus_instruct_filtered_lang_manual.json
```
